<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $categorey->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $categorey->id)]
            )
        ?></li>
...
<div class="categoreys form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Categorey') ?></legend>
        <?php
            echo $this->Form->input('parent_id', ['options' => $parentCategoreys, 'empty' => true]);
