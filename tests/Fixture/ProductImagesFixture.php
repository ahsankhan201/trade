...
class ProductImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_path' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'img_name' => ['type' => 'string', 'length' => 30, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'date_created' => '2015-09-22 06:19:25',
            'date_modified' => 1442902765
        ],
    ];
}
